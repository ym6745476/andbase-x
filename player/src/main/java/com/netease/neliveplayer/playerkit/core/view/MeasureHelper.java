...
public final class MeasureHelper {
    ...
    boolean doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 输入宽高spec
        LogUtil.ui("on measure, input widthMeasureSpec=" + MeasureSpec.toString(widthMeasureSpec)
        ...
        LogUtil.ui("on measure done, set measure width=" + mMeasuredWidth + ", height=" + mMeasuredHeight);
        return true;
    }
