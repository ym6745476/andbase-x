...
public class PlayerUtil {
    ...
    public static void savePlayPosition(Context context, String url, long position) {
        context.getSharedPreferences("VIDEO_PALYER_PLAY_POSITION",Context.MODE_PRIVATE)
                .edit()
    ...
    public static long getSavedPlayPosition(Context context, String url) {
        return context.getSharedPreferences("VIDEO_PALYER_PLAY_POSITION",Context.MODE_PRIVATE)
                .getLong(url, 0);
    }
}
