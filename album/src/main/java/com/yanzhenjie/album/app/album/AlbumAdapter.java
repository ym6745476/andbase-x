...
public class AlbumAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AlbumAdapter(Context context, boolean hasCamera, int choiceMode) {
        ...
        switch (viewType) {
            ...
            case TYPE_IMAGE: {
                ...
                if (mChoiceMode == Album.MODE_MULTIPLE) {
                    ...
                    imageViewHolder.mCheckBox.setTextColor(Color.WHITE);
                } else {
            ...
            case TYPE_VIDEO: {
                ...
                if (mChoiceMode == Album.MODE_MULTIPLE) {
                    ...
                    videoViewHolder.mCheckBox.setTextColor(Color.WHITE);
                } else {
