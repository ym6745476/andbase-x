...
public class AbAnimationUtil {
     ...
     */
    public static void playRotateAnimation(View v, long durationMillis, int repeatCount, int repeatMode, Interpolator interpolator) {

		Animation animation = AnimationUtils.loadAnimation(v.getContext(), R.anim.anim_rotate);
