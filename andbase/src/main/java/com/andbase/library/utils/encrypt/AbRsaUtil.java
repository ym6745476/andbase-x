...
public class AbRsaUtil {
	...
	public static String encrypt(String content, PublicKey publicKey) {
		try {
			...
			String s = new String(AbBase64Util.encode(output));
			return s;
		} catch (Exception e) {
			e.printStackTrace();
			return null;
	...
	public static String sign(String content, String privateKey) {
		try {
			PKCS8EncodedKeySpec priPKCS8 = new PKCS8EncodedKeySpec(
					AbBase64Util.decode(privateKey));
			...
			return AbBase64Util.encode(signed);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static boolean doCheck(String content, String sign, String publicKey) {
		try {
			...
			byte[] encodedKey = AbBase64Util.decode(publicKey);
			...
			boolean bverify = signature.verify(AbBase64Util.decode(sign));
			return bverify;
	...
	private static PublicKey getPublicKeyFromX509(String algorithm,
		...
		byte[] decodedKey = AbBase64Util.decode(bysKey);
    ...
    public static PublicKey loadPublicKey(String publicKey) throws Exception{
        try {
            byte[] buffer = AbBase64Util.decode(publicKey);
            KeyFactory keyFactory = KeyFactory.getInstance(ALGORITHM);
    ...
    public static PrivateKey loadPrivateKey(String privateKey) throws Exception{
        try{
            byte[] buffer = AbBase64Util.decode(privateKey);
            // X509EncodedKeySpec keySpec = new X509EncodedKeySpec(buffer);
