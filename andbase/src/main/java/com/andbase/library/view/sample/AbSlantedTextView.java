...
public class AbSlantedTextView extends View {
    ...
    public AbSlantedTextView(Context context) {
        this(context, null);
    }

    public AbSlantedTextView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public AbSlantedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AbSlantedTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(attrs);
    }

    public void init(AttributeSet attrs) {
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.AbSlantedTextView);

        mTextSize = array.getDimension(R.styleable.AbSlantedTextView_slantedTextSize, mTextSize);
        mTextColor = array.getColor(R.styleable.AbSlantedTextView_slantedTextColor, mTextColor);
        mSlantedLength = array.getDimension(R.styleable.AbSlantedTextView_slantedLength, mSlantedLength);
        mSlantedBackgroundColor = array.getColor(R.styleable.AbSlantedTextView_slantedBackgroundColor, mSlantedBackgroundColor);

        if (array.hasValue(R.styleable.AbSlantedTextView_slantedText)) {
            mSlantedText = array.getString(R.styleable.AbSlantedTextView_slantedText);
        }

        if (array.hasValue(R.styleable.AbSlantedTextView_slantedMode)) {
            mMode = array.getInt(R.styleable.AbSlantedTextView_slantedMode, 0);
        }
        array.recycle();
    ...
    public AbSlantedTextView setText(String str) {
        mSlantedText = str;
        postInvalidate();
        return this;
    }

    public AbSlantedTextView setText(int res) {
    ...
    public AbSlantedTextView setSlantedBackgroundColor(int color) {
    ...
    public AbSlantedTextView setTextColor(int color) {
        mTextColor = color;
        mTextPaint.setColor(mTextColor);
        postInvalidate();
        return this;
     ...
     * @return this
     */
    public AbSlantedTextView setMode(int mode) {
    ...
    public AbSlantedTextView setTextSize(int size) {
        this.mTextSize = size;
        mTextPaint.setTextSize(mTextSize);
        postInvalidate();
        return this;
     ...
     * @return this
     */
    public AbSlantedTextView setSlantedLength(int length) {
