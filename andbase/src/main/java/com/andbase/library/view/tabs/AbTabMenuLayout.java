...
public class AbTabMenuLayout extends LinearLayout {
    ...
    public AbTabMenuLayout(Context context) {
        this(context, null);
    }

    public AbTabMenuLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AbTabMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public AbTabMenuItemView getTabView(int tabIndex) {
        isInit();
    ...
    public void removeAllBadge() {
        isInit();
        for (AbTabMenuItemView alphaTabView : mTabViews) {
    ...
    private void init() {
        ...
        for (int i = 0; i < mChildCounts; i++) {
            if (getChildAt(i) instanceof AbTabMenuItemView) {
                AbTabMenuItemView tabView = (AbTabMenuItemView) getChildAt(i);
