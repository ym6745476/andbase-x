...
public class AbTabMenuItemView extends View {
    ...
    public AbTabMenuItemView(Context context) {
        this(context, null);
        mContext = context;
    }

    public AbTabMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        mContext = context;
    }

    public AbTabMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //获取所有的自定义属性
        TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.AbTabMenuItemView);
        BitmapDrawable iconNormal = (BitmapDrawable) a.getDrawable(R.styleable.AbTabMenuItemView_tabIconNormal);
        if (iconNormal != null) {
            mIconNormal = iconNormal.getBitmap();
        }
        BitmapDrawable iconSelected = (BitmapDrawable) a.getDrawable(R.styleable.AbTabMenuItemView_tabIconSelected);
        ...
        mText = a.getString(R.styleable.AbTabMenuItemView_tabText);
        mTextSize = a.getDimensionPixelSize(R.styleable.AbTabMenuItemView_tabTextSize, mTextSize);
        mTextColorNormal = a.getColor(R.styleable.AbTabMenuItemView_textColorNormal, mTextColorNormal);
        mTextColorSelected = a.getColor(R.styleable.AbTabMenuItemView_textColorSelected, mTextColorSelected);
        mBadgeBackgroundColor = a.getColor(R.styleable.AbTabMenuItemView_badgeBackgroundColor, mBadgeBackgroundColor);
        mPadding = (int) a.getDimension(R.styleable.AbTabMenuItemView_paddingTexwithIcon, mPadding);
        a.recycle();
        initText();
    }
