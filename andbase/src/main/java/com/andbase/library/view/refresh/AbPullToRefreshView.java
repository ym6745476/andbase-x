...
/**
 *  已经按照最新的Android X 修改
 *  修改与ViewPager一起用时的滑动冲突问题
 */

public class AbPullToRefreshView extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = AbPullToRefreshView.class.getSimpleName();
    ...
    AbPullCircleImageView mCircleView;
     ...
     * @param context
     */
    public AbPullToRefreshView(@NonNull Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public AbPullToRefreshView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void createProgressView() {
        mCircleView = new AbPullCircleImageView(getContext(), CIRCLE_BG_LIGHT);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(distanceX > mTouchSlop && distanceX > distanceY + 15) {
                    isMoving = true;
                    return false;
                }
