...
public class AbWaveView extends View {
    ...
    public AbWaveView(Context context) {
        super(context);
        init();
    }

    public AbWaveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AbWaveView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initAnimation(AbWaveView waveView) {
        ...
        ObjectAnimator waterLevelAnim = ObjectAnimator.ofFloat(
                waveView, "waterLevelRatio", startProgress, endProgress);
        ...
        ObjectAnimator amplitudeAnim = ObjectAnimator.ofFloat(
                waveView, "amplitudeRatio", 0.0001f, 0.10f);
