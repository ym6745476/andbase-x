 ...
 * @author clifford
 */
public class AbPhotoImageView extends AppCompatImageView {
        ...
        public interface OuterMatrixChangedListener {
             ...
             */
            void onOuterMatrixChanged(AbPhotoImageView pinchImageView);
        }
        ...
        public AbPhotoImageView(Context context) {
            super(context);
            initView();
        }

        public AbPhotoImageView(Context context, AttributeSet attrs) {
            super(context, attrs);
            initView();
        }

        public AbPhotoImageView(Context context, AttributeSet attrs, int defStyle) {
         ...
         * 在onTouchEvent末尾被执行.
         */
        private GestureDetector mGestureDetector = new GestureDetector(AbPhotoImageView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent e) {
                ...
                if (mOnLongClickListener != null) {
                    mOnLongClickListener.onLongClick(AbPhotoImageView.this);
                }
            }
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                if (mOnClickListener != null) {
                    mOnClickListener.onClick(AbPhotoImageView.this);
                }
                return true;
            }
        });
