 ...
 * Info 圆角ImageView
 */
public class AbRoundImageView  extends AbFilterImageView {

    private Context context;
    private float width,height;
    private float radius = 0;

    public AbRoundImageView(Context context) {
        this(context, null);
    }

    public AbRoundImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
