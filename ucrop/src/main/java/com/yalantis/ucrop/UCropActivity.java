...
public class UCropActivity extends AbBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = View.inflate(this,R.layout.ucrop_activity_photobox,null);
    ...
    private void setupViews(@NonNull Intent intent) {
        mStatusBarColor = intent.getIntExtra(UCrop.Options.EXTRA_STATUS_BAR_COLOR, colorPrimary);
        mToolbarColor = intent.getIntExtra(UCrop.Options.EXTRA_TOOL_BAR_COLOR,colorPrimary);
        mActiveWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_WIDGET_ACTIVE, colorAccent);
        mToolbarWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_COLOR_TOOLBAR, colorAccent);
        ...
        mRootViewBackgroundColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_ROOT_VIEW_BACKGROUND_COLOR, ContextCompat.getColor(this, com.andbase.library.R.color.black));
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        for (AspectRatio aspectRatio : aspectRatioList) {
            ...
            aspectRatioTextView.setActiveColor(mToolbarWidgetColor);
